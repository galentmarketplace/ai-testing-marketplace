...
**Project:** Agentic Testing Pipeline
**Generated:** 2026-07-22 13:13:43
...
- **Heading Font:** Fira Code (also used for data/mono)
- **Body Font:** Fira Sans (labels, prose)
- **Pairing:** "Dashboard Data" (Mono + Sans) — Fira family cohesion: Code for data, Sans for labels
- **Mood:** dashboard, data, analytics, code, technical, precise
- **Google Fonts:** [Fira Code + Fira Sans](https://fonts.googleapis.com/css2?family=Fira+Code:wght@400;500;600;700&family=Fira+Sans:wght@300;400;500;600;700&display=swap)

> Overridden from the auto-matched "Cinzel/Josefin Sans" (luxury real-estate serif), which misrouted for a technical monitoring dashboard. Corrected to the `--domain typography "technical developer dashboard"` match.
